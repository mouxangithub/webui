...
PANELS: list[dict[str, Any]] = [
  {
    ...
    "widgets": [
      ...
      {"type": "dual_button",
       "left": {"label": "Onroad Preview", "action": "onroad_preview", "dynamic_desc": "onroad_preview"},
       "right": {"label": "Onroad Preview", "action": "onroad_preview", "dynamic_desc": "onroad_preview"}},
      {"type": "dual_button",
