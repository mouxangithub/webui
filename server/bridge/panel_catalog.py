...
PANELS: list[dict[str, Any]] = [
  ...
  },
  {
    ...
    "widgets": [
      ...
      {"type": "text", "param": "CarName", "label": "Car Name", "offroad_only": True, "maxlength": 60,
       "desc": "Custom name for this car. Sent with Carrot FTP uploads and shown in the companion app."},
