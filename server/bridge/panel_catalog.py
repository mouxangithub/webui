  ...
  },
  {
    ...
    "widgets": [
      ...
      {"type": "bool", "param": "RecordAudio", "label": "Record and Upload Microphone Audio", "needs_cycle": True,
       ...
       "desc": "Record and store microphone audio while driving. The audio will be included in the dashcam upload when paired."},
  ...
  },
  {
    ...
    "widgets": [
      {"type": "bool", "param": "AdbEnabled", "label": "Enable ADB",
       "desc": "ADB (Android Debug Bridge) allows connecting to your device over USB or over the network."},
