...
PANELS: list[dict[str, Any]] = [
  {
    ...
    "widgets": [
      ...
      {"type": "separator"},
      {"type": "custom", "custom": "stream_preview_quality",
       "desc": "Camera preview quality for Web UI livestream. Auto lowers bitrate on weak network or when the device is warm. Does not affect driving recordings."},
