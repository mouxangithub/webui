  ...
  },
  {
    ...
    "widgets": [
      ...
      {"type": "multiple_button", "param": "LongitudinalPersonality", "label": "Driving Personality",
       ...
       "desc": "Standard is recommended. In aggressive mode, sunnypilot will follow lead cars closer and be more aggressive with the gas and brake. In relaxed mode sunnypilot will stay further away from lead cars."},
  ...
  },
  {
    ...
    "widgets": [
      {"type": "option", "param": "OnroadScreenOffBrightness", "label": "Onroad Brightness",
       "min": 0, "max": 22, "step": 1, "label_format": "onroad_brightness", "layout": "stacked"},
