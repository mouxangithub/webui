...
_WEBUI_STRINGS: dict[str, dict[str, str]] = {
  "en": {
    ...
    "Vehicle / CAN Speed Arbitration": "Vehicle / CAN Speed Arbitration",
    "Vehicle Navi CAN Control": "Vehicle Navi CAN Control",
    "Highway variant. Default 0 (disabled).": "Highway variant. Default 0 (disabled).",
    "Highway variant. Default 5.": "Highway variant. Default 5.",
    "Highway variant. Default 80.": "Highway variant. Default 80.",
    "Toyota: Auto Brake Hold FOR TSS2 HYBRID CARS": "Toyota: Auto Brake Hold FOR TSS2 HYBRID CARS",
    "Use the vehicle's auto brake hold feature on supported TSS2 hybrid Toyotas.": "Use the vehicle's auto brake hold feature on supported TSS2 hybrid Toyotas.",
    "Toyota: Prius TSS2 BSM and some tssp": "Toyota: Prius TSS2 BSM and some tssp",
    "Enable enhanced blind-spot monitoring behavior for certain Prius TSS2 and TSS-P Toyotas.": "Enable enhanced blind-spot monitoring behavior for certain Prius TSS2 and TSS-P Toyotas.",
    "Toyota: custom longitudinal for TSS2": "Toyota: custom longitudinal for TSS2",
    "Use a custom longitudinal tuning profile for TSS2 Toyota vehicles.": "Use a custom longitudinal tuning profile for TSS2 Toyota vehicles.",
    "Enable drive mode btn link": "Enable drive mode btn link",
    "Link the Toyota drive-mode button (ECO/NORMAL/SPORT) into sunnypilot logic.": "Link the Toyota drive-mode button (ECO/NORMAL/SPORT) into sunnypilot logic.",
  },
  "zh-CHS": {
    "Web UI": "Web UI",
    "Local": "本地",
    ...
    "Highway variant. Default 0 (disabled).": "高速版本。默认 0（禁用）。",
    "Highway variant. Default 5.": "高速版本。默认 5。",
    "Highway variant. Default 80.": "高速版本。默认 80。",
    "Toyota: Auto Brake Hold FOR TSS2 HYBRID CARS": "Toyota: TSS2 混动自动驻车",
    "Use the vehicle's auto brake hold feature on supported TSS2 hybrid Toyotas.": "在支持的 TSS2 混动丰田车型上使用自动驻车保持功能。",
    "Toyota: Prius TSS2 BSM and some tssp": "Toyota: 普锐斯 TSS2 BSM 及部分 TSS-P",
    "Enable enhanced blind-spot monitoring behavior for certain Prius TSS2 and TSS-P Toyotas.": "为部分普锐斯 TSS2 及 TSS-P 丰田车型启用增强型盲区监测行为。",
    "Toyota: custom longitudinal for TSS2": "Toyota: TSS2 自定义纵向控制",
    "Use a custom longitudinal tuning profile for TSS2 Toyota vehicles.": "为 TSS2 丰田车辆使用自定义纵向控制曲线。",
    "Enable drive mode btn link": "启用驾驶模式按钮联动",
    "Link the Toyota drive-mode button (ECO/NORMAL/SPORT) into sunnypilot logic.": "将丰田驾驶模式按钮（ECO/NORMAL/SPORT）接入 sunnypilot 逻辑。",
  },
  "zh-CHT": {
    "Web UI": "Web UI",
    "Local": "本機",
    ...
    "ETA": "剩餘",
    "Curve": "彎道",
    "Toyota: Auto Brake Hold FOR TSS2 HYBRID CARS": "Toyota: TSS2 油電自動煞車保持",
    "Use the vehicle's auto brake hold feature on supported TSS2 hybrid Toyotas.": "在支援的 TSS2 油電豐田車款上使用自動煞車保持功能。",
    "Toyota: Prius TSS2 BSM and some tssp": "Toyota: Prius TSS2 BSM 及部分 TSS-P",
    "Enable enhanced blind-spot monitoring behavior for certain Prius TSS2 and TSS-P Toyotas.": "為部分 Prius TSS2 及 TSS-P 豐田車款啟用增強型盲點監測行為。",
    "Toyota: custom longitudinal for TSS2": "Toyota: TSS2 自定義縱向控制",
    "Use a custom longitudinal tuning profile for TSS2 Toyota vehicles.": "為 TSS2 豐田車輛使用自定義縱向控制曲線。",
    "Enable drive mode btn link": "啟用駕駛模式按鈕連動",
    "Link the Toyota drive-mode button (ECO/NORMAL/SPORT) into sunnypilot logic.": "將豐田駕駛模式按鈕（ECO/NORMAL/SPORT）接入 sunnypilot 邏輯。",
  },
}
